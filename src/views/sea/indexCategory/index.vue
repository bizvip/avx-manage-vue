...
const options = reactive({
  ...
  add: {
    ...
    auth: ["sea:indexCategory:save"],
  },
  edit: {
    show: true,
    api: staticIndexCategory.update,
    auth: ["sea:indexCategory:update"],
  },
  delete: {
    show: true,
    api: staticIndexCategory.deletes,
    auth: ["sea:indexCategory:delete"],
    realApi: staticIndexCategory.realDeletes,
    realAuth: ["sea:indexCategory:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticIndexCategory.recoverys,
    auth: ["sea:indexCategory:recovery"],
  },
...
<script>
export default { name: "sea:indexCategory" };
</script>