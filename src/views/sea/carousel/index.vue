...
const options = reactive({
  ...
  add: {
    ...
    auth: ["sea:carousel:save"],
  },
  edit: {
    show: true,
    api: staticCarousel.update,
    auth: ["sea:carousel:update"],
  },
  delete: {
    show: true,
    api: staticCarousel.deletes,
    auth: ["sea:carousel:delete"],
    realApi: staticCarousel.realDeletes,
    realAuth: ["sea:carousel:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticCarousel.recoverys,
    auth: ["sea:carousel:recovery"],
  },
...
<script>
export default { name: "sea:carousel" };
</script>