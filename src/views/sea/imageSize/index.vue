...
const options = reactive({
  ...
  add: {
    ...
    auth: ["sea:imageSize:save"],
  },
  edit: {
    show: true,
    api: staticImageSize.update,
    auth: ["sea:imageSize:update"],
  },
  delete: {
    show: true,
    api: staticImageSize.deletes,
    auth: ["sea:imageSize:delete"],
    realApi: staticImageSize.realDeletes,
    realAuth: ["sea:imageSize:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticImageSize.recoverys,
    auth: ["sea:imageSize:recovery"],
  },
...
<script>
export default { name: "sea:imageSize" };
</script>