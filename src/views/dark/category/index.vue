...
const options = reactive({
  ...
  add: {
    ...
    auth: ["dark:category:save"],
  },
  edit: {
    show: true,
    api: staticCategory.update,
    auth: ["dark:category:update"],
  },
  delete: {
    show: true,
    api: staticCategory.deletes,
    auth: ["dark:category:delete"],
    realApi: staticCategory.realDeletes,
    realAuth: ["dark:category:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticCategory.recoverys,
    auth: ["dark:category:recovery"],
  },
});
...
<script>
export default { name: "dark:category" };
</script>