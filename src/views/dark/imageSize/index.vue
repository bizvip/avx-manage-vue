...
const options = reactive({
  ...
  add: {
    ...
    auth: ["dark:imageSize:save"],
  },
  edit: {
    show: true,
    api: staticImageSize.update,
    auth: ["dark:imageSize:update"],
  },
  delete: {
    show: true,
    api: staticImageSize.deletes,
    auth: ["dark:imageSize:delete"],
    realApi: staticImageSize.realDeletes,
    realAuth: ["dark:imageSize:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticImageSize.recoverys,
    auth: ["dark:imageSize:recovery"],
  },
...
<script>
export default { name: "dark:imageSize" };
</script>