  ...
  <div>
    <a-alert type="info" :show-icon="false">
      <a-space>
        ...
        <icon-notification />
        <a-typography-text
          >由于CDN等缓存分发的作用，时间设置可能存在数分钟延迟</a-typography-text
        >
      </a-space>
    </a-alert>
...
const options = reactive({
  ...
  edit: {
    ...
    auth: ["dark:icon:update"],
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ["dark:icon:delete"],
    realApi: staticBanner.realDeletes,
    realAuth: ["dark:icon:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ["dark:icon:recovery"],
  },
