...
const options = reactive({
  ...
  edit: {
    ...
    auth: ["sex8:icon:update"],
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ["sex8:icon:delete"],
    realApi: staticBanner.realDeletes,
    realAuth: ["sex8:icon:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ["sex8:icon:recovery"],
  },
...
const columns = reactive([
  ...
  },
  {
    ...
    search: true,
    dict: {
      url: "static/indexCategory/dict?site_id=" + SITE_ID,
      props: {
        label: "name",
        value: "id",
      },
