...
const options = reactive({
  ...
  add: {
    ...
    auth: ["sex8:banner:save"],
  },
  edit: {
    show: true,
    api: staticBanner.update,
    auth: ["sex8:banner:update"],
  },
  delete: {
    show: true,
    api: staticBanner.deletes,
    auth: ["sex8:banner:delete"],
    realApi: staticBanner.realDeletes,
    realAuth: ["sex8:banner:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticBanner.recoverys,
    auth: ["sex8:banner:recovery"],
  },
...
<script>
export default { name: "sex8:banner" };
</script>