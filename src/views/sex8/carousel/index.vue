...
const options = reactive({
  ...
  add: {
    ...
    auth: ["sex8:carousel:save"],
  },
  edit: {
    show: true,
    api: staticCarousel.update,
    auth: ["sex8:carousel:update"],
  },
  delete: {
    show: true,
    api: staticCarousel.deletes,
    auth: ["sex8:carousel:delete"],
    realApi: staticCarousel.realDeletes,
    realAuth: ["sex8:carousel:realDeletes"],
  },
  recovery: {
    show: true,
    api: staticCarousel.recoverys,
    auth: ["sex8:carousel:recovery"],
  },
...
<script>
export default { name: "sex8:carousel" };
</script>