<template>
  <div class="work-area p-5">
    ...
    <div class="ma-content-block shadow p-5 mt-5">
      <a-space class="mb-5">
        <a-button type="primary" @click="() => globalParamsRef.open()"
          >设置全局参数</a-button
        >
        <a-button type="primary" status="danger" @click="clearGlobalParams"
          >清除全局参数</a-button
        >
        <a-button type="primary" status="warning" @click="getIdentity"
          >生成简易模式 Identity</a-button
        >
        <a-button type="primary" status="warning" @click="getAccessToken"
          >生成复杂模式 AccessToken</a-button
        >
      </a-space>
