    ...
    <div class="ma-content-block shadow p-5">
      ...
      <div class="ma-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          ...
          的简易模式在请求时需要携带
          <a-tag color="magenta">app_id</a-tag>
          和
          <a-tag color="magenta">identity</a-tag>
          认证参数
        </div>
      </div>
      <div class="ma-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          只需要对
          <a-tag color="orangered">app id</a-tag>
          和
          <a-tag color="orangered">app secret</a-tag>
          进行
          <a-tag color="blue">MD5</a-tag>
          即可
        </div>
      </div>
    </div>
    ...
    <div class="ma-content-block shadow p-5 mt-5">
      ...
      <div class="ma-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          ...
          <a-tag color="red">AccessToken</a-tag>
          的接口时候，服务器会对用户请求合法性的
          <a-tag color="purple">signature</a-tag>
          进行检查，以此来确定是否向用户返回
          <a-tag color="red">AccessToken</a-tag>
        </div>
      </div>
      ...
      <div class="ma-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          ...
          获取
          <a-tag color="magenta">app id</a-tag>
          和
          <a-tag color="magenta">app secret</a-tag>
        </div>
      </div>
      ...
      <div class="ma-content-block shadow p-5 mt-5 leading-10">
        ...
        <div>
          ...
          <div>
            ...
            地址：
            <a-tag color="green"
              >http://你的服务器地址/api/v1/getAccessToken</a-tag
            >
            请求方法：
            <a-tag color="pinkpurple">POST</a-tag>
          </div>
