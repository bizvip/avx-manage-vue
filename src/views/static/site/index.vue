...
const genMenu = (record) => {
  // staticSite.genMenu(record).then(res => {res.success && Message.success(res.message)}).catch(e => {Message.error(res.message) && console.log(e)})
};
...
<script>
export default { name: "static:site" };
</script>