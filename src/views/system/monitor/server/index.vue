    ...
    <div class="ma-content-block lg:flex p-4 mt-3" v-if="memory">
      ...
      <div class="flex justify-between w-full redis-info mt-3" v-else>
        ...
        >
          ...
          <a-descriptions-item label="已使用内存"
            >{{ memory.usage }}G
          </a-descriptions-item>
          <a-descriptions-item label="应用使用内存"
            >{{ memory.php }}M
          </a-descriptions-item>
    ...
    <div class="ma-content-block lg:flex p-4 mt-3" v-if="phpenv">
      ...
      <div class="flex justify-between w-full redis-info mt-3" v-else>
        ...
        >
          ...
          <a-descriptions-item label="底层环境"
            >{{ phpenv.php_version }}
          </a-descriptions-item>
          <a-descriptions-item label="协程环境"
            >{{ phpenv.swoole_version }}
          </a-descriptions-item>
          <a-descriptions-item label="框架"
            >{{ phpenv.hyperf_version }}
          </a-descriptions-item>
          <a-descriptions-item label="M3521综合视频管理系统">
            1.0.0</a-descriptions-item
          >
          <a-descriptions-item label="系统物理路径"
            >{{ phpenv.project_path }}
          </a-descriptions-item>
          <a-descriptions-item label="系统启动时间"
            >{{ phpenv.start_time }}
          </a-descriptions-item>
